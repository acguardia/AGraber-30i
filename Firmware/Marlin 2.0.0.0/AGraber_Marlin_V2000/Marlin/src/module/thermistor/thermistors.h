...
#endif
#if ANY_THERMISTOR_IS(4) // beta25 = 3950 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Generic 1mm Bulb"
  #include "thermistor_4.h"
#endif
#if ANY_THERMISTOR_IS(5) // beta25 = 4267 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, ""Generic 2mm Bulb"
...
#endif
#if ANY_THERMISTOR_IS(27) // Chinese Thermistor for a Bed MK2b with 2.0mm commun glass. Calibration by AC Guardia.
  #include "thermistor_27.h"
#endif
...
#if THERMISTOR_HEATER_41
  #define HEATER_4_TEMPTABLE TT_NAME(THERMISTOR_HEATER_41)
