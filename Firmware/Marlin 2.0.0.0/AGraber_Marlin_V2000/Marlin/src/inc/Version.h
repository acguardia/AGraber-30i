 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "Firm. Vers.: 2.0.0"

  /**
   * Verbose version identifier which should contain a reference to the location
   * from where the binary was downloaded or the source code was compiled.
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " A.Graber"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "31-06-2019"
   ...
   */
  #define MACHINE_NAME "A.Graber 30i"
