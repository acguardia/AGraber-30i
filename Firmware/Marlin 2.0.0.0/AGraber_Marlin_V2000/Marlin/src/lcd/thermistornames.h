...
// Standard thermistors
...
#elif THERMISTOR_ID == 4
  #define THERMISTOR_NAME "Chinese 1mm Bulb 100K"
#elif THERMISTOR_ID == 5
  #define THERMISTOR_NAME "Chinese 2mm Bulb 100K"
  ...
  #define THERMISTOR_NAME "JGAurora Thermistor"
...
#elif THERMISTOR_ID == 27
  #define THERMISTOR_NAME "Chinese Bed"
