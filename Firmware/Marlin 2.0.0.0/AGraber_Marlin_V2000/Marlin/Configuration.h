...
#define STRING_CONFIG_H_AUTHOR "(Antonio C Guardia, AGraber 30i)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "A.Graber 30i"
 ...
 *     4 : Chinese Thermistor, most common in E3D clone hotend with 1mm bulb - Table maked by Antonio C. Guardia
 *     5 : Chinese Thermistor, most common in E3D clone hotend with 2mm bulb - Table maked by Antonio C. Guardia
 ...
 */ 
#define TEMP_SENSOR_0 13		// PARA O PROJETO DA AGRABER, USE O TERMISTOR NUMEROS 4 ou 5
#define TEMP_SENSOR_1 0
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_4 0
#define TEMP_SENSOR_5 0
#define TEMP_SENSOR_BED 4	// PARA O PROJETO DA AGRABER, USE O TERMISTOR NUMERO 4 ou 5
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_OPENLOOP 10       // Puts PID in open loop. M104/M140 sets the output power from 0 to PID_MAX
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // FIND YOUR OWN: "M303 E-1 C8 S110 U1" to run autotune on the bed at 90 degreesC for 8 cycles.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
//#define DEFAULT_MAX_ACCELERATION      { 800, 800,  75, 5000 }
...
#define Z_SERVO_ANGLES {10,120}  // Z Servo Deploy and Stow angles
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    0 // Z Clearance for Deploy/Stow Guardia
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR     //CASO USE SENSOR DE FINAL DE FILAMENTO, HABILITE ESSA LINHA.
