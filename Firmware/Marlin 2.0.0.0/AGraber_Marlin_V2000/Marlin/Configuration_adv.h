...
// Homing hits each endstop, retracts by these distances, then does a slower bump. Guardia
#define X_HOME_BUMP_MM 5
#define Y_HOME_BUMP_MM 5
#define Z_HOME_BUMP_MM 2
#define HOMING_BUMP_DIVISOR { 5, 5, 20 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
