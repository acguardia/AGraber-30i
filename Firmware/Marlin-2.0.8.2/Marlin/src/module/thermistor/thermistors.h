...
#endif
//
#if ANY_THERMISTOR_IS(24) // By termistor 100K chinês com bulbo de 1mm, criado por Antonio C. Guardia. 52 medicoes
  #include "thermistor_24.h"
#endif
#if ANY_THERMISTOR_IS(25) // By termistor 100K chinês com bulbo de 2mm, criado por Antonio C. Guardia. 53 medicoes
