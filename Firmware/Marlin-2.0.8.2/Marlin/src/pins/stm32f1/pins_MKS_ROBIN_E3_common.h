 ...
 */
    ...
    */
 /*********************************************************************************************************   
 *FYSETC MINI12864 V2.1 PIN MAP MAKE BY 'WILL DA SILVA' TO AGRABER PROJECT (www.thingiverse.com/thing:3436936).*
 *********************************************************************************************************/
		...
		//#define LCD_BACKLIGHT_PIN           -1
			...
			// #define RGB_LED_R_PIN      PA7
			// #endif
			// #ifndef RGB_LED_G_PIN
			// #define RGB_LED_G_PIN      PC4
			// #endif
			// #ifndef RGB_LED_B_PIN
			// #define RGB_LED_B_PIN      PC5
			// #endif
			#if ENABLED(FYSETC_MINI_12864_2_1)
			//#define NEOPIXEL_PIN         PA7
				#define DOGLCD_CS           PA4
				#define DOGLCD_A0           PA5
				#define LCD_RESET_PIN       PA6 // Must be high or open for LCD to operate normally.
				#define LCD_PINS_D4         PA6
				#define LCD_CONTRAST 220
			#endif
...
#define SD_SS_PIN                           PA15
 ...
 /*********************************************************************************************************   
 *FYSETC MINI12864 PIN MAP MAKE BY 'WILL DA SILVA' TO AGRABER PROJECT (www.thingiverse.com/thing:3436936).*
 *********************************************************************************************************/
 /*
 *               -----                                             -----
 ...
 *  *            -----                                          Mapeado E3D
 *           NC | 1 2 | GND                                    5V | 1 2 | GND
 *        RESET | 3 4 | PC10 (SD_DETECT)             (LCD_D7) PC5 | 3 4 | PC4 (LCD_D6)
 *  (MOSI) PB15 | 5 6   PB0  (BTN_EN2)               (LCD_D5) PA7 | 5 6 | PA6 (LCD_D4)
 * (SD_SS) PA15 | 7 8 | PB11 (BTN_EN1)               (LCD_RS) PA5 | 7 8 | PA4 (LCD_EN)
 *   (SCK) PB13 | 9 10| PB14  (MISO)                (BTN_ENC) PC3 | 9 10| PC1 (BEEPER)
 *               -----                                             -----
 *               EXP2                                              EXP1
 *
*/